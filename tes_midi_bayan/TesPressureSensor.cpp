...
#define PRESSURE_EVENT_PERIOD   50      // 20 events per second
...
#define pressureTopValue    350     // max values for "blow" & "suck" are not the same; let's use the lowest one, so that both can reach this value
