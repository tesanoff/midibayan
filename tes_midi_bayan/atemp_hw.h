...
const char atInstrumentName72[] PROGMEM  = "Эл. Гитара (чистая) 126";       // 126:
const char atInstrumentName73[] PROGMEM  = "Эл. Гитара (приглушенная)";     // 0:28
const char atInstrumentName74[] PROGMEM  = "Эл. Гитара (фанк)";             // 8:28
const char atInstrumentName75[] PROGMEM  = "Эл. Гитара (overdrive)";        // 0:29
const char atInstrumentName76[] PROGMEM  = "Эл. Гитара (overdrive) 126";    // 126:29
const char atInstrumentName77[] PROGMEM  = "Эл. Гитара (distorsion)";       // 0:30
const char atInstrumentName78[] PROGMEM  = "Эл. Гитара (feedback)";         // 8:30
const char atInstrumentName79[] PROGMEM  = "Эл. Гитара (Гарм.)";            // 0:31
const char atInstrumentName80[] PROGMEM  = "Эл. Гитара (feedback) 2";       // 8:31
